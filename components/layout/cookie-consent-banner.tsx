...
export default function CookieConsentBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-4 z-[100] px-4">
      <div className="mx-auto max-w-[720px] rounded-[28px] border border-[#d8cbbf] bg-[#f8f2ed]/95 p-4 shadow-[0_18px_46px_rgba(61,49,40,0.20)] backdrop-blur-md sm:p-5">
        <p className="text-sm leading-7 text-[#5f5248] sm:text-base">
