...
export default function BeforeAfterSection() {
  return (
    <SectionShell
      ...
      eyebrow="Результаты"
      title="До / После"
      description="Покажи человеку наглядно, какой результат он получит после загрузки своих фото."
      className="bg-[#f7f1eb]"
    >
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {items.map((item, index) => (
          <div
            ...
            className="overflow-hidden rounded-[28px] border border-[#eadfd6] bg-white"
          >
            <div
            ...
            />
            <div className="border-t border-[#efe4db] p-4">
