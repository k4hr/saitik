...
import { Sparkles, Wallet, Shield, Clock3, Gift } from "lucide-react";
...
export default function DashboardOverview({
  ...
  const [timeLeft, setTimeLeft] = useState(
    formatTimeLeft(welcomeOfferEndsAt),
  );
              ...
              <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
                <div>
                  ...
                  <p className="mt-4 max-w-2xl text-base leading-8 text-[#6f6156]">
                    Только первый час после регистрации для вас действует
                    специальная цена на тариф <span className="font-medium">Студия</span>.
                  </p>
